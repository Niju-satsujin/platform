...
## Work (main)
### Step 1
**Do this:** Pick log format (key=value or JSON) and implement required fields in code.
Optional: document them if you want.

**How to test it:**
- Run: `./tests/run.sh`

**Expected result:**
- Harness validates required logging behavior with PASS/FAIL.
