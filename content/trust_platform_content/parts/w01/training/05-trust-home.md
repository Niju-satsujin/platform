...
## Work (main)
### Step 1
**Do this:** Implement a stable TRUST_HOME layout in code (at minimum `config/` and `logs/`).
Optional: document it if you want.

**How to test it:**
- Run: `./tests/run.sh`

**Expected result:**
- Harness validates TRUST_HOME behavior and path resolution.
...
## Ship (5 min)
- Submit: config/path code updates + test proof
