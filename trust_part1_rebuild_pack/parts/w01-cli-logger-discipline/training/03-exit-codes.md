...
## Work (main)
### Step 1
**Do this:** Document exit codes in your CLI contract (success / usage / runtime).

**How to test it:**
- Run: `grep -n "exit" docs/cli-contract.md | head`

**Expected result:**
- Your docs mention exit code meaning.
...
## Ship (5 min)
- Submit: updated docs + signal handling changes
